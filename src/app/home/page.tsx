...
const primaryFeatures = [
  ...
  {
    name: '100+ Mock Interviews',
    description: 'Practice across a wide-spectrum of questions.',
    icon: LockClosedIcon,
  },
  {
    name: 'Personal Database',
    description: 'Revisit your past interviews and track your progress.',
    icon: ServerIcon,
  },
];
const secondaryFeatures = [
  {
    ...
    description: 'Prepare in the language of choice across 10+ languages.',
    href: '#',
    icon: CloudArrowUpIcon,
  },
  {
    ...
    description:
      'Detailed analysis with over 50 metrics to track your progress. Confidence, content relevancy, fluency, and more.',
    href: '#',
    icon: LockClosedIcon,
  },
  {
    name: 'Simple cues',
    description:
      "Krint cues to help you understand the interviewer's body language and tone.",
    href: '#',
    icon: ArrowPathIcon,
  },
];
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex ">
                <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  <span className="font-semibold text-indigo-600">beta</span>
                  {/* <span
                    aria-hidden="true"
              ...
              <h1 className="mt-4 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                A better way to prepare
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Anxious about your dream job interview? <br />
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Practice. Get feedback. Take control. Get hired.
                </p>
              </div>
              <img
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need for your dream job
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Questions. Case studies. Detailed performance report. Tracking.
              Tutorials. Nudges. Everything you need to ace your dream job
            </p>
          </div>
